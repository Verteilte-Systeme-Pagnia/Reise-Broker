...
public abstract class Config {
    public final static int Coordinator1Port = 5000;//working2pc.Broker1
    public  static InetAddress Coordinator1Address;

    public final static int Coordinator2Port = 5001;//working2pc.Broker2
    ...
    public final static int ClientPort = 5002;//working2pc.Client
