...
import fehler.fehlerfall2.java.logic.transaction.SenderReference;
                ...
                System.out.println("CoordinatorReceive Prüfen Nachrichten typ");
                 if(initializeMsg.contains("checkAvailability")) {//prüfen ob es sich um eine Verfügbarkeitsanfrage handelt wenn ja...
                     ...
                     if (participants.stream().anyMatch(participantRef -> participantRef.getAddress().equals(receiveDP.getAddress()) && participantRef.getPort() == receiveDP.getPort())) {//Prüfen ob Nachricht von einem Partizipanten stammt wenn ja...
                         ...
                         SenderReference senderReference = uuidTransactionParticipantClient.get(UUID.fromString(splitInitializeMsg[3])); //erhalten der Cleint Reference um die Verfügbarkeitsanfrage an den fehler.fehlerfall2.java.Client zurückzusenden mit den Informationen die vom Partizipanten erhalten wurden
                     ...
                     if (participants.stream().anyMatch(participantRef -> participantRef.getAddress().equals(receiveDP.getAddress()) && participantRef.getPort() == receiveDP.getPort())) {//Nachricht von Partizipanten
                     ...
                     } else {//Nachricht von fehler.fehlerfall2.java.Client
                         System.out.println("CoordinatorReceive Prüfen Nachrichten typ kein CheckAvailability von fehler.fehlerfall2.java.Client");
                         ...
                         System.out.println("CoordinatorReceive Prüfen Nachrichten typ kein CheckAvailability von fehler.fehlerfall2.java.Client starten einer neuen Transaktion");
                     }
                 }
            }
