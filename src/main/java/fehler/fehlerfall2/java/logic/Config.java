package fehler.fehlerfall2.java.logic;// Package not detected, please report project structure on CodeTogether's GitHub Issues

import java.net.InetAddress;

public abstract class Config {
    public final static int Coordinator1Port = 5000;//fehler.fehlerfall2.java.Broker1
    public  static InetAddress Coordinator1Address;

    public final static int Coordinator2Port = 5001;//fehler.fehlerfall2.java.Broker2
    ...
    public final static int ClientPort = 5002;//fehler.fehlerfall2.java.Client
