...
import fehler.fehlerfall3.java.logic.transaction.SenderReference;
import fehler.fehlerfall3.java.logic.transaction.TransactionCoordinator;
import fehler.fehlerfall3.java.logic.transaction.WriteLogFile;
                ...
                System.out.println("CoordinatorReceive Prüfen Nachrichten typ");
                 if(initializeMsg.contains("checkAvailability")) {//prüfen ob es sich um eine Verfügbarkeitsanfrage handelt wenn ja...
                     ...
                     if (participants.stream().anyMatch(participantRef -> participantRef.getAddress().equals(receiveDP.getAddress()) && participantRef.getPort() == receiveDP.getPort())) {//Prüfen ob Nachricht von einem Partizipanten stammt wenn ja...
                         ...
                         SenderReference senderReference = uuidTransactionParticipantClient.get(UUID.fromString(splitInitializeMsg[3])); //erhalten der Cleint Reference um die Verfügbarkeitsanfrage an den fehler.fehlerfall3.java.Client zurückzusenden mit den Informationen die vom Partizipanten erhalten wurden
                     ...
                     if (participants.stream().anyMatch(participantRef -> participantRef.getAddress().equals(receiveDP.getAddress()) && participantRef.getPort() == receiveDP.getPort())) {//Nachricht von Partizipanten
                     ...
                     } else {//Nachricht von fehler.fehlerfall3.java.Client
                         System.out.println("CoordinatorReceive Prüfen Nachrichten typ kein CheckAvailability von fehler.fehlerfall3.java.Client");
                         ...
                         System.out.println("CoordinatorReceive Prüfen Nachrichten typ kein CheckAvailability von fehler.fehlerfall3.java.Client starten einer neuen Transaktion");
                     }
                 }
            }
