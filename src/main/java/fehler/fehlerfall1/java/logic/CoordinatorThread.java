...
import static fehler.fehlerfall1.java.logic.transaction.states_coordinator.Finish;
...
public class CoordinatorThread extends Thread{
    ...
    private void sendClientMessage(){ //Methode für den SENDCLIENT Zustand des CoordinatorThreads
        ...
        try{
            ...
            socket.send(dp);
            System.out.println("CoordinatorThread "+this.uuid+" Nachricht an fehler.fehlerfall1.java.Client gesendet");
