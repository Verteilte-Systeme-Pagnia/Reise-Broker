...
public abstract class Config {
    public final static int Coordinator1Port = 5000;//fehler.fehlerfall1.java.Broker1
    public  static InetAddress Coordinator1Address;

    public final static int Coordinator2Port = 5001;//fehler.fehlerfall1.java.Broker2
    ...
    public final static int ClientPort = 5002;//fehler.fehlerfall1.java.Client
